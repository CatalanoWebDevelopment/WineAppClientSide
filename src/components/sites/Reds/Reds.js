...
export default class Reds extends Component {
    ...
    loadAllWines = () => {
        ...
        fetch('http://localhost:3000/wines/all', {
            ...
            let filteredWines = data.filter(wine => wine.color === "Red" || wine.color === "red")
    ...
    render() {
        return(
            <Grid container spacing={24}>
                ...
                <Grid item xs={6} className="centered">
                    <Button color="default" variant="contained" onClick={this.switchState}>Create a New Red Wine</Button>
